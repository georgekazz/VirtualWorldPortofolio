...
<head>
    ...
    <title>Σχετικά | Virtual Portfolio</title>
...
<body class="bg-gray-900 text-white min-h-screen relative">
    ...
    <main class="pt-24 pb-16 px-6 sm:px-10 max-w-4xl mx-auto relative z-10">
        <h1 class="text-4xl sm:text-5xl font-bold mb-6 text-center text-purple-400">Σχετικά με εμένα</h1>
        <p class="text-lg text-gray-300 leading-relaxed mb-8 text-center">
            Είμαι ένας digital creator με πάθος για την εικονική πραγματικότητα, τον 3D σχεδιασμό και τις διαδραστικές
            εμπειρίες. Μέσα από αυτό το portfolio παρουσιάζω τα έργα μου που συνδυάζουν δημιουργικότητα, τεχνολογία και
            φαντασία.
        </p>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
            <div>
                <h2 class="text-2xl font-semibold text-purple-300 mb-3">Τι κάνω:</h2>
                <ul class="space-y-2 text-gray-300 list-disc list-inside">
                    <li>3D περιβάλλοντα με Three.js & Blender</li>
                    <li>Διαδραστικές Web Εφαρμογές με Laravel & Vue</li>
                    <li>AR/VR πρωτότυπα</li>
                    <li>UI/UX σχεδίαση και παρουσίαση έργων</li>
                </ul>
            </div>
            <div>
                <h2 class="text-2xl font-semibold text-purple-300 mb-3">Τεχνολογίες:</h2>
                <ul class="space-y-2 text-gray-300 list-disc list-inside">
                    <li>Laravel, PHP, MySQL</li>
                    <li>Tailwind CSS, Vue.js</li>
                    <li>Three.js, WebGL, GLSL</li>
                    <li>Figma, Blender, Unity</li>
                </ul>
            </div>
        </div>
    </main>
    ...
    <script>
        ...
        const material = new THREE.MeshStandardMaterial({ color: 0x7f00ff, metalness: 0.6, roughness: 0.4 });
